...
zxd.dialogx(title, content, btn1, cb1, btn2, cb2, btn3, cb3, outsideClose, outsideFn, style) 扩展对话框，支持1-3个按钮 zxd.dialogx('提示', '内容', '确定', fn, false, null, 'light1')
zxd.dialogi(title, content, btn1, cb1, btn2, cb2, outsideClose, outsideFn, style) 输入框对话框，返回 Promise var val = await zxd.dialogi('输入', '请输入姓名:', '确定')
...
方法 说明 示例
zxd.bm(direction, id, colors) 设置渐变背景 `zxd.bm('topbottom', 'box', '#ff0000
